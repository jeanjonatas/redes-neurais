const MODEL_PATH =
    ...
    'http://0.0.0.0:8000/model/model.json';
    //'https://storage.googleapis.com/tfjs-models/tfjs/model_v1_0.25_224/model.json';
...
const modelDemo = async () => {
  ...
  status('Loading Complete, Upload an Image');
 ...
 * @param logits Tensor representing the logits from model.
